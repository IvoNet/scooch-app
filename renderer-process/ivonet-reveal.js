...
var reveal_config = {
   ...
   chalkboard: {
      ...
      background: [
         'rgba(127,127,127,.1)',
         'resource:///plugins/chalkboard/img/blackboard.png'
      ],
      pen: [
         'resource:///plugins/chalkboard/img/boardmarker.png',
         'resource:///plugins/chalkboard/img/chalk.png'
      ]
   },
   ...
   dependencies: [
      {
         src: 'resource:///node_modules/reveal.js/lib/js/classList.js', condition: function () {
         return !document.body.classList;
      }
      },
      {
         src: 'resource:///node_modules/reveal.js/plugin/markdown/marked.js', condition: function () {
         return !!document.querySelector('[data-markdown]');
      }
      },
      {
         src: 'resource:///node_modules/reveal.js/plugin/markdown/markdown.js', condition: function () {
         return !!document.querySelector('[data-markdown]');
      }
      },
      {
         src: 'resource:///node_modules/reveal.js/plugin/highlight/highlight.js', async: true, callback: function () {
         hljs.initHighlightingOnLoad();
      }
      },
      {
         src: 'resource:///node_modules/reveal.js/plugin/zoom-js/zoom.js', async: true, condition: function () {
         return !!document.body.classList;
      }
      },
      ...
      {
         src: 'resource:///plugins/reveal-code-focus/reveal-code-focus.js', async: true, callback: function () {
         RevealCodeFocus();
      }
      },
      {src: 'resource:///plugins/chalkboard/chalkboard.js'},
      {src: 'resource:///plugins/spreadsheet/spreadsheet.js'},
      {src: 'resource:///plugins/mathsvg/math.js', async: true},
      {src: 'resource:///plugins/jump/jump.js', async: true}
